local L = LibStub("AceLocale-3.0"):NewLocale("OmniAuras", "zhCN")
...
L["Arena Party CastBars"] = "竞技场队友施法条"
--[[Translation missing --]]
L["Arena Unit Frame"] = "Arena Unit Frame"
L["Aura Alert"] = "法术效果警报"
L["Aura Blacklist"] = "法术效果黑名单"
L["Aura Editor"] = "法术效果编辑器"
L["Aura ID"] = "法术ID"
--[[Translation missing --]]
L["Auras"] = "Auras"
--[[Translation missing --]]
...
L["Enabling this option will disable Buff Frames."] = "启动这个选项会关闭增益框体"
--[[Translation missing --]]
...
L["healing"] = "Heal"
L["Health Bar"] = "生命条"
L["Health Bar Left"] = "生命条左边"
L["Health Bar Right"] = "生命条右边"
L["Health Bar Top Center"] = "生命条顶部中间"
--[[Translation missing --]]
L["Height"] = "Height"
...
L["Use this frame to display both buffs and debuffs."] = "使用这个框体显示所有增益和减益效果"
--[[Translation missing --]]
